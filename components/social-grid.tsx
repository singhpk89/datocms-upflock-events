...
import { parseISO, format, isBefore, isAfter } from 'date-fns';
 ...
 function SocialCard({ props: WallData }) {
   return (
     <div>Hello</div>
   );
 }
 ...
 export default function SocialGrid({ sponsors }: Props) {

  function dateConvert(date:string){
   const current_datetime =  new Date(date); 
    // const formatted_date = current_datetime.toTimeString();
   ...
   return (
     <>
       ...
       <div className={styles.grid}>
         ...
         <Link key={sponsor.username} href="#">
         <a
           role="button"
           tabIndex={0}
         ...
         >
           ...
           <Image
             ...
             src={sponsor.path == '' ? IMG_URL+'filename/aFr8XWw9Lv2PEc5w30qb56JKc1wvVYKS7BKNP0iT.jpg' : IMG_URL+sponsor.path}
           ...
           />
            ...
            <div className={styles.cardBody}>
             <div>
               ...
               <p className={styles.description}>{sponsor.message}</p>
             </div>
           </div>

           <div className={styles.cardBody}>
           <div className="row m-1 item-center">
           <img 
              ...
              />
               <p className="pl-2 margin-auto h-24 col-4">{sponsor.username}</p>

<div className="mr-1 h-24 justify-content-end col-6">{dateConvert(sponsor.time)}</div>
          </div>
            </div>
