 ...
 */
 ...
 function SocialCard({ sponsor }: { sponsor: Sponsor }) {
   return (
     <Link key={sponsor.name} href="#">
       <a
         role="button"
         tabIndex={0}
       ...
       >
         <div className={styles.imageWrapper}>
           <Image
             alt={sponsor.name}
             src="https://images.pexels.com/photos/2521470/pexels-photo-2521470.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
         ...
         <div className="row m-1 item-center">
              ...
              <p className="pl-2 margin-auto h-24 col-5">  Prakash</p>

              <div className="mr-3 h-24 justify-content-end col-5">  24 Apr 2021</div>
     ...
     <>
       <div className={styles.grid}>
         {otherSponsors.map(sponsor => (
           <SocialCard key={sponsor.name} sponsor={sponsor} />
         ))}
       </div>
       <div className={styles.grid}>
